...
public class MemberAndAttendance {
	...
	public MemberAndAttendance() {
		super();
	}

	public MemberAndAttendance(Long memberCode, String memberName, String memberBirth, String memberTel,
	...
	public String toString() {
		return "MemberAndAttendance [memberCode=" + memberCode + ", memberName=" + memberName + ", memberBirth="
