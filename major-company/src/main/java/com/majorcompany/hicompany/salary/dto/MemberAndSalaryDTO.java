...
public class MemberAndSalaryDTO {
	...
	private List<Salary> memberSalary = new ArrayList<>();
	
	public MemberAndSalaryDTO() {
	}

	public MemberAndSalaryDTO(Long memberCode, String memberName, String memberBirth, String memberTel,
